...
自動テストは `tests.html` を開くと実行されます。現在のテスト数は389件です。
...
- 背面強調、四点支持、膝立ち、前傾支持、表情、顔隠し腕動作の正規化、助言、生成、旧保存データ移行
- 文字・記号抑制と服保持のON/OFF、背面衣装、旧保存データへの初期値補完
