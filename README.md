...
- 43件すべてのビルトインプリセット、コレクション・撮影範囲・タグの分類と件数
- relationship 28件のメタデータ、相手視点、hard警告、公開向け禁止語
...
ベッド、ソファ、歩きながらの距離感、ハート、抱きしめる直前、頬へ触れる仕草などを、公開向けの中立的な文言で扱います。性的・露骨な表現を目的としたツールではありません。
